								...
								<div class="cs-entry__content-wrap">
									...
									<div class="entry-content">
										<div class="woocommerce">
											...
											<h2 id="login">Ma'lumotlarni tahrirlash</h2>


                                            <h4>Shaxsiy sahifaga rasm joylash</h4>
                                            @if ($usp->image_path == '')
											@if ($errors->any())
											...
											@endif
											<form action="{{ route('updatePhoto', ['user_id' => Auth::user()->id]) }}" method="POST" enctype="multipart/form-data">
												@csrf
												@method('PUT')
                                            ...
                                            @else
												<form action="{{ route('deletePhoto', ['user_id' => Auth::user()->id]) }}" method="POST">
													@csrf
													@method('PUT')
													<p>Rasm mavjud. <button type="submit">Olib tashlash</button></p>
												</form>
                                            @endif
                                            ...
                                            <h4>Ijtimoiy tarmoqdagi sahifalarni tahrirlash
                                            <form class="woocommerce-form woocommerce-form-login login" action="{{ route('socialUpdate', ['user_id'=>Auth::user()->id]) }}" method="POST">
                                                @method('PUT')
                                                @csrf
                                                <p style="font-size: 14px;">Mavjud ijtimoiy tarmoq havola-linkini kiriting</p>
                                                <p
                                                    class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                    <label for="telegram">Telegram&nbsp;
                                                    <input type="text"
                                                        class="woocommerce-Input woocommerce-Input--text input-text"
                                                        name="telegram" id="telegram" autocomplete="telegram"
                                                        placeholder="Shaxsiy sahifa linki"
                                                ...
                                                <p
                                                    ...
                                                    <input type="text"
                                                        class="woocommerce-Input woocommerce-Input--text input-text"
                                                        name="instagram" id="instagram" autocomplete="instagram"
                                                        placeholder="Shaxsiy sahifa linki"
                                                ...
                                                <p
                                                    ...
                                                    <input class="woocommerce-Input woocommerce-Input--text input-text"
                                                        ...
                                                        placeholder="Shaxsiy sahifa linki" autocomplete="facebook"
                                            ...
                                            <hr style="margin-top: 30px;">
                                                <h4>Ijtimoiy tarmoqdagi sahifalarni qo'shish
                                                <form class="woocommerce-form woocommerce-form-login login" action="{{ route('social') }}" method="POST">
                                                    @csrf
                                                    <p style="font-size: 14px;">Mavjud ijtimoiy tarmoq havola-linkini kiriting</p>
                                                    <p
                                                        class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                            ...
                                            <hr style="margin-top: 30px;">
                                            <h4>Shaxsiy ma'lumotlarni o'zgartirish
											<form class="woocommerce-form woocommerce-form-login login" action="{{ route('userUpdate', ['user_id'=>Auth::user()->id]) }}" method="POST">
												@csrf
                                                @method('PUT')
												@error('name')
												<div
												...
												<p
													class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													<label for="name">Ism Familiya&nbsp;<span
															class="required">*</span></label>
													<input type="text"
														class="woocommerce-Input woocommerce-Input--text input-text"
														name="name" id="name" autocomplete="Email"
														placeholder="Ism familiyangizni yozing"
														value="{{ $user->name }}" />
												</p>
												<p
													class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
												...
												<p
													class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													<label for="phone">Telefon raqam&nbsp;<span
															class="required">*</span></label>
													<input type="text"
														class="woocommerce-Input woocommerce-Input--text input-text"
														name="phone" id="phone" autocomplete="phone"
														placeholder="Telefon raqam (+998913123452)"
														value="{{ $user->phone }}" />
												</p>
												...
												<p
													class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
													<label for="password_confirmation">Parolni tasdiqlash&nbsp;<span
															class="required">*</span></label>
													<input class="woocommerce-Input woocommerce-Input--text input-text"
														type="password" name="password_confirmation"
														id="password_confirmation" placeholder="Parolni qayta kiriting"
												...
												<p class="form-row">
													<button type="submit"
														class="woocommerce-button button woocommerce-form-login__submit"
														name="login" value="Log in">Saqlash</button>
												</p>
